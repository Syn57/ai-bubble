...
fun Project.configureBadgingTasks(
    ...
    // Register a callback to be called when a new variant is configured
    componentsExtension.onVariants { variant ->
        // Register a new task to verify the new app bundle
        ...
        tasks.register<CheckBadgingTask>(checkBadgingTaskName){
            ...
            output.set(
                project.layout.buildDirectory.dir("intermediate/$checkBadgingTaskName")
            )
        }
    }
}